...
function LoadingPage() {
  ...
  const loadingSteps = [
    {
      title: "Analyzing your brand identity...",
      description: "We are reviewing your brand personality, tone, and goals.",
    },
    {
      title: "Understanding your target audience...",
      description:
        "We are identifying who your audience is and what matters most to them.",
    },
    {
      title: "Generating content ideas...",
      description:
        "We are creating personalized content ideas for your business.",
    },
    {
      title: "Building your content strategy...",
      description: "We are preparing your custom strategy and content plan.",
    },
    {
      title: "Finalizing everything...",
      description:
        "We are preparing your personalized dashboard with strategy and topic ideas.",
    },
  ];
    ...
    const runLoadingSequence = async () => {
      ...
      const generationPromise = onboardingData
        ? fetch("https://planmycontent.onrender.com/api/auth/generate-results", {
            ...
            .catch((error) => {
              console.error("Loading page generation error:", error);
              return null;
            })
      ...
      writeIdeasPayload(GENERATED_RESULTS_KEY, generatedResults);
  ...
  }, [navigate, loadingSteps.length, onboardingData]);
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 py-10"
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/4 h-64 w-64 -translate-x-1/2 rounded-full bg-orange-500/5 blur-[80px]" />
      ...
      >
        ...
        <div className="relative flex flex-col items-center text-center">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
            {["Personalized Strategy", "AI Generated Ideas", "Custom Dashboard"].map((label) => (
              <div
                key={label}
                className="rounded-xl px-4 py-2 text-xs font-semibold"
                style={{
                  background: "rgba(244,124,53,0.06)",
                  border: "1px solid rgba(244,124,53,0.15)",
